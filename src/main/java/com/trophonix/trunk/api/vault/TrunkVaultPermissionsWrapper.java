...
public class TrunkVaultPermissionsWrapper extends TrunkPermissions {
    ...
    @Override
    public boolean has(UUID uniqueId, String node) {
        return wrapped.has(Bukkit.getWorlds().get(0).getName(), UUIDStore.getName(uniqueId), node);
    }
    ...
    @Override
    public boolean has(String world, UUID uniqueId, String node) {
        return wrapped.has(world, UUIDStore.getName(uniqueId), node);
    }

    @Override
    public boolean playerHas(UUID uniqueId, String node) {
        return wrapped.playerHas(Bukkit.getWorlds().get(0).getName(), UUIDStore.getName(uniqueId), node);
    }
    ...
    public boolean playerAdd(UUID uniqueId, String node) {
        return wrapped.playerAdd(Bukkit.getWorlds().get(0).getName(), UUIDStore.getName(uniqueId), node);
    }
    ...
    public boolean playerRemove(UUID uniqueId, String node) {
        return wrapped.playerRemove(Bukkit.getWorlds().get(0).getName(), UUIDStore.getName(uniqueId), node);
    }
    ...
    public boolean playerAddGroup(UUID uniqueId, String group) {
        return wrapped.playerAddGroup(Bukkit.getWorlds().get(0).getName(), UUIDStore.getName(uniqueId), group);
    }
    ...
    public boolean playerRemoveGroup(UUID uniqueId, String group) {
        return wrapped.playerRemoveGroup(Bukkit.getWorlds().get(0).getName(), UUIDStore.getName(uniqueId), group);
    }
    ...
    public boolean playerInGroup(UUID uniqueId, String group) {
        return wrapped.playerInGroup(Bukkit.getWorlds().get(0).getName(), UUIDStore.getName(uniqueId), group);
    }
    ...
    public boolean groupHas(String group, String node) {
        return wrapped.groupHas(Bukkit.getWorlds().get(0).getName(), group, node);
    }
    ...
    public boolean groupAdd(String group, String node) {
        return wrapped.groupAdd(Bukkit.getWorlds().get(0).getName(), group, node);
    }
    ...
    public boolean groupRemove(String group, String node) {
        return wrapped.groupRemove(Bukkit.getWorlds().get(0).getName(), group, node);
    }
    ...
    public Iterable<String> getPlayerGroups(UUID uniqueId) {
        return Arrays.asList(wrapped.getPlayerGroups(Bukkit.getWorlds().get(0).getName(), UUIDStore.getName(uniqueId)));
    }
    ...
    public String getPrimaryGroup(UUID uniqueId) {
        return wrapped.getPrimaryGroup(Bukkit.getWorlds().get(0).getName(), UUIDStore.getName(uniqueId));
    }
